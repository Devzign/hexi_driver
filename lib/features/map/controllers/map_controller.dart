...
class RiderMapController extends GetxController implements GetxService {
  ...
  void setFromToMarker(LatLng from, LatLng to, {bool updateLiveLocation = false}) async{
    markers = HashSet();
    Uint8List fromMarker = await convertAssetToUnit8List(Images.fromIcon, width: 70);
    Uint8List toMarker = await convertAssetToUnit8List(Images.targetLocationIcon, width: 45);
